          ...
          {item.type === "product" ? (
            <div className="flex items-center gap-2">
              <button
                ...
                className="w-7 h-7 rounded-md border border-gray-300 flex items-center justify-center text-gray-500 hover:border-green-400 hover:text-green-600 transition-colors cursor-pointer"
              >
                -
              </button>
            ...
            <input
              ...
              className="text-xs border border-gray-300 rounded-md px-2 py-1 w-32 focus:border-green-500 focus:outline-none"
            />
          )}
        </div>
      </div>
