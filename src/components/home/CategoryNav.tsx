      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
        {categories.slice(0, 6).map((cat) => (
          <Link
            ...
            className="group cursor-pointer bg-white dark:bg-gray-800 p-8 rounded-2xl border border-green-500/5 hover:border-green-500/40 hover:shadow-xl hover:shadow-green-500/5 transition-all text-center"
          >
