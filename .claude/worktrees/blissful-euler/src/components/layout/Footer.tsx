        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-sm text-gray-400 leading-relaxed max-w-xs">
              ...
              trusted businesses for products and services across Nigeria.
            </p>
            <div className="flex gap-3 mt-6">
              {["twitter", "instagram", "facebook"].map((social) => (
                <span
                  key={social}
                  className="w-9 h-9 bg-gray-800 hover:bg-green-600 rounded-xl flex items-center justify-center text-gray-400 hover:text-white transition-all cursor-pointer"
                >
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-2.5">
              {["About Us", "How It Works", "For Business", "Blog", "Careers"].map(
                (item) => (
                  <li key={item}>
